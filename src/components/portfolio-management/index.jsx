      ...
      <section className="w-full h-full font-dmSans bg-[#130A0A] pt-[6rem]">
        <div className='flex justify-between gap-32 px-14'>
            <div className='flex-1 flex flex-col items-start gap-6 pt-[3rem]'>
                <span className="text-[1.563rem] font-semibold text-[#e2d9d8]">Portfolio Management</span>
                <p className="text-[0.875rem] text-slate-300">Managing investment portfolio for clients, which affords them the opportunity of enjoying the returns and benefits of both the capital and money markets. It cuts across Equities Investment in blue-chip quoted/unquoted companies...</p>
