...
import AssetBgImg from "../../assets/asset-management-bg.svg";
...
export const VamcoCardImg = () => {
  const styles = {
    backgroundImage: `url(${AssetBgImg})`,
  ...
  return (
    <section className="w-full h-full font-dmSans pb-[3rem] bg-[#130A0A]">
      <div className="px-14">
        <div className="relative bg-[#451a1d] text-[#fff] p-5 rounded-lg flex justify-between gap-28">
          <div>
            <img
              src={VamconCardImg}
          ...
          <div className="flex flex-col items-start justify-between">
            ...
            <div className="flex flex-col items-start gap-2">
              <p className="text-[#d3c8c9] text-base">
